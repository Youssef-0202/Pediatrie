package ma.zs.gestion_service_pediatrie.zynerator.security.common;
...
import ma.zs.gestion_service_pediatrie.Gestion_service_pediatrieApplication;
...
public class SecurityUtil {
    ...
    public static User getCurrentUser() {
        UserService userService= Gestion_service_pediatrieApplication.getCtx().getBean(UserService.class);
