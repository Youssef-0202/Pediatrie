package ma.zs.gestion_service_pediatrie.service.impl.medecin.consultatio;
...
import ma.zs.gestion_service_pediatrie.service.facade.medecin.dossie.RadiologieMedecinService ;
...
import ma.zs.gestion_service_pediatrie.service.facade.medecin.commun.MedecinMedecinService ;
...
public class ConsultationMedecinServiceImpl implements ConsultationMedecinService {
    ...
    @Autowired
    private FichePatientMedecinService fichePatientService ;
    @Autowired
    private RadiologieMedecinService radiologieService ;
    @Autowired
    private InfermierMedecinService infermierService ;
    @Autowired
    private MedecinMedecinService medecinService ;
    @Autowired
    private SyntheseMedicaleMedecinService syntheseMedicaleService ;
    @Autowired
