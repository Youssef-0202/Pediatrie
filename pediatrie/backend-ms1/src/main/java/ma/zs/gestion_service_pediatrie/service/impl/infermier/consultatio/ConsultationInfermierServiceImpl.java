package ma.zs.gestion_service_pediatrie.service.impl.infermier.consultatio;
...
import ma.zs.gestion_service_pediatrie.service.facade.infermier.dossie.RadiologieInfermierService ;
import ma.zs.gestion_service_pediatrie.bean.core.dossie.Radiologie ;
import ma.zs.gestion_service_pediatrie.service.facade.infermier.commun.InfermierInfermierService ;
import ma.zs.gestion_service_pediatrie.service.facade.infermier.commun.MedecinInfermierService ;
import ma.zs.gestion_service_pediatrie.service.facade.infermier.rappor.SyntheseMedicaleInfermierService ;
...
@Service
public class ConsultationInfermierServiceImpl implements ConsultationInfermierService {
    ...
    @Autowired
    private FichePatientInfermierService fichePatientService ;
    @Autowired
    private RadiologieInfermierService radiologieService ;
    @Autowired
    private InfermierInfermierService infermierService ;
    @Autowired
    private MedecinInfermierService medecinService ;
    @Autowired
    private SyntheseMedicaleInfermierService syntheseMedicaleService ;
    @Autowired
    private PatientInfermierService patientService ;
    @Autowired
    private DiagnosticInfermierService diagnosticService ;
    @Autowired
    private AnalyseMedicaleInfermierService analyseMedicaleService ;
