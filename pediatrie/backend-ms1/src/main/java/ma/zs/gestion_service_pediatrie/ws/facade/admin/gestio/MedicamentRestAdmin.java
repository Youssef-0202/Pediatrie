package  ma.zs.gestion_service_pediatrie.ws.facade.admin.gestio;
...
@RestController
@RequestMapping("/api/admin/medicament/")
public class MedicamentRestAdmin {
    ...
    @Autowired private MedicamentAdminService service;
