...
@RestController
@RequestMapping("/api/medecin/antecedent/")
public class AntecedentRestMedecin {
    ...
    @Operation(summary = "find by dossier num")
    @GetMapping("dossier/num/{num}")
    public List<AntecedentDto> findByNumDossier(@PathVariable String num){
        return findDtos(service.findNumDossier(num));
    }
    ...
    @Autowired private AntecedentMedecinService service;
