package  ma.zs.gestion_service_pediatrie.ws.facade.admin.consultatio;
...
public class ConsultationRestAdmin {
    ...
    @Autowired private ConsultationAdminService service;
