...
import ma.zs.gestion_service_pediatrie.service.facade.admin.dossie.GroupeSanguinAdminService;
...
@RestController
@RequestMapping("/api/admin/groupeSanguin/")
public class GroupeSanguinRestAdmin {
    ...
    @Autowired private GroupeSanguinAdminService service;
