...
import java.util.List;
@Service
public class TraitementAdminServiceImpl implements TraitementAdminService {
    ...
    @Autowired
    private OrdonnanceAdminService ordonnanceService ;
    @Autowired
    private ConsultationAdminService consultationService ;
    @Autowired
    private MedicamentAdminService medicamentService ;
