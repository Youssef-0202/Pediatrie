...
@RestController
@RequestMapping("/api/medecin/ordonnance/")
public class OrdonnanceRestMedecin {
    ...
    public List<OrdonnanceDto> findByNumDossier(@PathVariable String num){
    ...
    @Autowired private OrdonnanceMedecinService service;
