package  ma.zs.gestion_service_pediatrie.ws.facade.medecin.consultatio;
...
@RestController
@RequestMapping("/api/medecin/consultation/")
public class ConsultationRestMedecin {
    ...
    public List<ConsultationDto> findByPatientNumDossier(@PathVariable String num){
    ...
    public ResponseEntity<ConsultationDto> save(@RequestBody ConsultationDto dto) throws Exception {
        if(dto!=null){
            ...
            System.out.println(myT.getMedecin());
    ...
    @Autowired private ConsultationMedecinService service;
