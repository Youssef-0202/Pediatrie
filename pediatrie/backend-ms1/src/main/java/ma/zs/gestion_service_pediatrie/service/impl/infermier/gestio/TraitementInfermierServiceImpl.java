package ma.zs.gestion_service_pediatrie.service.impl.infermier.gestio;
...
import java.util.List;
@Service
public class TraitementInfermierServiceImpl implements TraitementInfermierService {
    ...
    @Autowired
    private OrdonnanceInfermierService ordonnanceService ;
    @Autowired
    private ConsultationInfermierService consultationService ;
    @Autowired
    private MedicamentInfermierService medicamentService ;
