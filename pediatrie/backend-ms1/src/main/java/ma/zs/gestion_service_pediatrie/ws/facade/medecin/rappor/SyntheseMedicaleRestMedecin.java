package  ma.zs.gestion_service_pediatrie.ws.facade.medecin.rappor;
...
@RestController
@RequestMapping("/api/medecin/syntheseMedicale/")
public class SyntheseMedicaleRestMedecin {
    ...
    @Autowired private SyntheseMedicaleMedecinService service;
