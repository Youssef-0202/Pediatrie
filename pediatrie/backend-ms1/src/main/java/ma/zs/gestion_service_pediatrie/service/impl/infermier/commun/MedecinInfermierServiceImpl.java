package ma.zs.gestion_service_pediatrie.service.impl.infermier.commun;
...
import ma.zs.gestion_service_pediatrie.service.facade.infermier.commun.SexeInfermierService ;
...
import java.util.List;
@Service
public class MedecinInfermierServiceImpl implements MedecinInfermierService {
    ...
    public Medecin update(Medecin t) {
        ...
        if (loadedItem == null) {
            throw new EntityNotFoundException("errors.notFound", new String[]{Medecin.class.getSimpleName(), t.getId().toString()});
        } else {
            dao.save(t);
            return loadedItem;
        }
    ...
    public Medecin create(Medecin t) {
        ...
        Role role = new Role();
        role.setAuthority(AuthoritiesConstants.INFERMIER);
    ...
    @Autowired
    private SexeInfermierService sexeService ;
