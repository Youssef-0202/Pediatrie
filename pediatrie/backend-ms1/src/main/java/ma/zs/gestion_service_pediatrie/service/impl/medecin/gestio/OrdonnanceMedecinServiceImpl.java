...
import java.util.List;
@Service
public class OrdonnanceMedecinServiceImpl implements OrdonnanceMedecinService {
    ...
    public List<Ordonnance> findByConsultatuinPatientNumDossier(String num) {
        return dao.findByConsultatuinPatientNumDossier(num);
    }
