...
import java.util.List;
@Service
public class InfermierAdminServiceImpl implements InfermierAdminService {
	...
	public boolean deleteById(Long id) {
        ...
        System.out.println("delete by id executed");
    ...
    public List<Infermier> delete(List<Infermier> list) {
        System.out.println("method delete list infermier executed");

        for (Infermier t : list) {
            modelPermissionUserService.deleteByUserId(t.getId());
    ...
    public Infermier create(Infermier t) {
        System.out.println("Infermier saved");
        ...
        t.setTelephone(t.getTelephone());
        t.setEmail(t.getEmail());
        Role role = roleService.findByAuthority(AuthoritiesConstants.INFERMIER);
