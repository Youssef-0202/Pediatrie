package  ma.zs.gestion_service_pediatrie.ws.facade.medecin.gestio;
...
@RestController
@RequestMapping("/api/medecin/certificat/")
public class CertificatRestMedecin {
    ...
    public List<CertificatDto> findByNumDossier(@PathVariable String num){
        return findDtos(service.findByConsultatuinPatientNumDossier(num));
    }
    ...
    @Autowired private CertificatMedecinService service;
