package  ma.zs.gestion_service_pediatrie.ws.facade.infermier.commun;
...
@RestController
@RequestMapping("/api/infermier/infermier/")
public class InfermierRestInfermier {
    ...
    @Autowired private InfermierInfermierService service;
