...
@Component({
  selector: 'app-synthese-medicale-list-infermier',
  templateUrl: './synthese-medicale-list-infermier.component.html'
})
export class SyntheseMedicaleListInfermierComponent implements OnInit {
