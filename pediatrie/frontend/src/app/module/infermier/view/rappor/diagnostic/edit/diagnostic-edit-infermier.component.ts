...
@Component({
  selector: 'app-diagnostic-edit-infermier',
  templateUrl: './diagnostic-edit-infermier.component.html'
})
export class DiagnosticEditInfermierComponent implements OnInit {
