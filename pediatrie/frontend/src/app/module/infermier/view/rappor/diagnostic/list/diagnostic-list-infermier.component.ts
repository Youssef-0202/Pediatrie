...
@Component({
  selector: 'app-diagnostic-list-infermier',
  templateUrl: './diagnostic-list-infermier.component.html'
})
export class DiagnosticListInfermierComponent implements OnInit {

    protected fileName = 'Diagnostic';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DiagnosticDto>();
    ...
    public async edit(dto: DiagnosticDto) {
    ...
    public async view(dto: DiagnosticDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DiagnosticDto) {
    ...
    public async duplicate(dto: DiagnosticDto) {
    ...
    public exportPdf(dto: DiagnosticDto): void {
...
// add
	...
	public initDuplicate(res: DiagnosticDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Ref': e.ref ,
                'Date diagnostic': this.datePipe.transform(e.dateDiagnostic , 'dd/MM/yyyy hh:mm'),
        ...
        this.criteriaData = [{
            ...
            'Date diagnostic Min': this.criteria.dateDiagnosticFrom ? this.datePipe.transform(this.criteria.dateDiagnosticFrom , this.dateFormat) : environment.emptyForExport ,
            'Date diagnostic Max': this.criteria.dateDiagnosticTo ? this.datePipe.transform(this.criteria.dateDiagnosticTo , this.dateFormat) : environment.emptyForExport ,
    ...
    get selections(): Array<DiagnosticDto> {
        return this.service.selections;
    }

    set selections(value: Array<DiagnosticDto>) {
