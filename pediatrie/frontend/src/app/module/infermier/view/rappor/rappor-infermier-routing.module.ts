                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: DiagnosticListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'synthese-medicale',
                            children: [
                                {
                                    path: 'list',
                                    component: SyntheseMedicaleListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class RapporInfermierRoutingModule { }
