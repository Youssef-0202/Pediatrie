...
@Component({
  selector: 'app-synthese-medicale-edit-infermier',
  templateUrl: './synthese-medicale-edit-infermier.component.html'
})
export class SyntheseMedicaleEditInfermierComponent implements OnInit {
