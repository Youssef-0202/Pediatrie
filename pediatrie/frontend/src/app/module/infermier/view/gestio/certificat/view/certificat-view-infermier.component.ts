...
@Component({
  selector: 'app-certificat-view-infermier',
  templateUrl: './certificat-view-infermier.component.html'
})
export class CertificatViewInfermierComponent implements OnInit {
    ...
    constructor(private service: CertificatInfermierService, private consultationService: ConsultationInfermierService){
