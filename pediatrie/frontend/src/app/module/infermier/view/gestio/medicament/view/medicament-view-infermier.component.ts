...
@Component({
  selector: 'app-medicament-view-infermier',
  templateUrl: './medicament-view-infermier.component.html'
})
export class MedicamentViewInfermierComponent implements OnInit {
    ...
    constructor(private service: MedicamentInfermierService, private traitementService: TraitementInfermierService){
