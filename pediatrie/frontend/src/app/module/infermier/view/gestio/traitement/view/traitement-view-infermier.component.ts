...
@Component({
  selector: 'app-traitement-view-infermier',
  templateUrl: './traitement-view-infermier.component.html'
})
export class TraitementViewInfermierComponent implements OnInit {
    ...
    constructor(private service: TraitementInfermierService, private ordonnanceService: OrdonnanceInfermierService, private consultationService: ConsultationInfermierService, private medicamentService: MedicamentInfermierService){
