...
@Component({
  selector: 'app-certificat-edit-infermier',
  templateUrl: './certificat-edit-infermier.component.html'
})
export class CertificatEditInfermierComponent implements OnInit {
