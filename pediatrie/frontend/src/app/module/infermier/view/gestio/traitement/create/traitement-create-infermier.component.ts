...
@Component({
  selector: 'app-traitement-create-infermier',
  templateUrl: './traitement-create-infermier.component.html'
})
export class TraitementCreateInfermierComponent  implements OnInit {
