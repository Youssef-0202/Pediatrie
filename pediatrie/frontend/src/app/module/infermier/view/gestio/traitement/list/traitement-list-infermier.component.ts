...
@Component({
  selector: 'app-traitement-list-infermier',
  templateUrl: './traitement-list-infermier.component.html'
})
export class TraitementListInfermierComponent implements OnInit {
