...
@Component({
  selector: 'app-ordonnance-edit-infermier',
  templateUrl: './ordonnance-edit-infermier.component.html'
})
export class OrdonnanceEditInfermierComponent implements OnInit {
