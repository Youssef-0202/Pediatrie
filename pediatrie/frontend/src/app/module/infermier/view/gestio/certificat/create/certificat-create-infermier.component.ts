...
@Component({
  selector: 'app-certificat-create-infermier',
  templateUrl: './certificat-create-infermier.component.html'
})
export class CertificatCreateInfermierComponent  implements OnInit {
