...
@Component({
  selector: 'app-medicament-create-infermier',
  templateUrl: './medicament-create-infermier.component.html'
})
export class MedicamentCreateInfermierComponent  implements OnInit {
