...
@Component({
  selector: 'app-radiologie-create-infermier',
  templateUrl: './radiologie-create-infermier.component.html'
})
export class RadiologieCreateInfermierComponent  implements OnInit {
