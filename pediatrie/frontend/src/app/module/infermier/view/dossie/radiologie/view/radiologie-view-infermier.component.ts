...
@Component({
  selector: 'app-radiologie-view-infermier',
  templateUrl: './radiologie-view-infermier.component.html'
})
export class RadiologieViewInfermierComponent implements OnInit {
    ...
    constructor(private service: RadiologieInfermierService, private consultationService: ConsultationInfermierService, private typeImageService: TypeImageInfermierService){
