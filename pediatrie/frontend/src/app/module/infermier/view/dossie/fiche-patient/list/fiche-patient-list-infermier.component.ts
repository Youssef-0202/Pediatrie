...
@Component({
  selector: 'app-fiche-patient-list-infermier',
  templateUrl: './fiche-patient-list-infermier.component.html'
})
export class FichePatientListInfermierComponent implements OnInit {
