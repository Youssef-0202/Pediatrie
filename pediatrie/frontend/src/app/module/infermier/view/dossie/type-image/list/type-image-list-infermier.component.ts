...
@Component({
  selector: 'app-type-image-list-infermier',
  templateUrl: './type-image-list-infermier.component.html'
})
export class TypeImageListInfermierComponent implements OnInit {

    protected fileName = 'TypeImage';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeImageDto>();
    ...
    public async edit(dto: TypeImageDto) {
    ...
    public async view(dto: TypeImageDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeImageDto) {
    ...
    public async duplicate(dto: TypeImageDto) {
    ...
    public exportPdf(dto: TypeImageDto): void {
...
// add
	...
	public initDuplicate(res: TypeImageDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeImageDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeImageDto>) {
