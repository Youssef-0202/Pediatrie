...
@Component({
  selector: 'app-analyse-medicale-create-infermier',
  templateUrl: './analyse-medicale-create-infermier.component.html'
})
export class AnalyseMedicaleCreateInfermierComponent  implements OnInit {
