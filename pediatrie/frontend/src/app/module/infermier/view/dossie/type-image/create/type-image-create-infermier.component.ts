...
@Component({
  selector: 'app-type-image-create-infermier',
  templateUrl: './type-image-create-infermier.component.html'
})
export class TypeImageCreateInfermierComponent  implements OnInit {
