...
@Component({
  selector: 'app-antecedent-create-infermier',
  templateUrl: './antecedent-create-infermier.component.html'
})
export class AntecedentCreateInfermierComponent  implements OnInit {
   ...
   private _validAntecedentRef = true;
    ...
    const isPermistted = await this.roleService.isPermitted('GroupeSanguin', 'add');
    if(isPermistted) {
