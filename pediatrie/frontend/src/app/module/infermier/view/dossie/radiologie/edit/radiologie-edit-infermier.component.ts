...
@Component({
  selector: 'app-radiologie-edit-infermier',
  templateUrl: './radiologie-edit-infermier.component.html'
})
export class RadiologieEditInfermierComponent implements OnInit {
