...
@Component({
  selector: 'app-antecedent-edit-infermier',
  templateUrl: './antecedent-edit-infermier.component.html'
})
export class AntecedentEditInfermierComponent implements OnInit {
