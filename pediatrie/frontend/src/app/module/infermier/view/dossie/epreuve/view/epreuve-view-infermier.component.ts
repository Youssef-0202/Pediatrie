...
@Component({
  selector: 'app-epreuve-view-infermier',
  templateUrl: './epreuve-view-infermier.component.html'
})
export class EpreuveViewInfermierComponent implements OnInit {
    ...
    constructor(private service: EpreuveInfermierService){
