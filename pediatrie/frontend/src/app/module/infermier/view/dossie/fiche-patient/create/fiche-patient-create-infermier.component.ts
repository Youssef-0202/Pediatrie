...
@Component({
  selector: 'app-fiche-patient-create-infermier',
  templateUrl: './fiche-patient-create-infermier.component.html'
})
export class FichePatientCreateInfermierComponent  implements OnInit {
