...
@Component({
  selector: 'app-analyse-medicale-list-infermier',
  templateUrl: './analyse-medicale-list-infermier.component.html'
})
export class AnalyseMedicaleListInfermierComponent implements OnInit {
