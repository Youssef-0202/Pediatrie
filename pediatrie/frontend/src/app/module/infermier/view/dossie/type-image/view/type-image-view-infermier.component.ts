...
@Component({
  selector: 'app-type-image-view-infermier',
  templateUrl: './type-image-view-infermier.component.html'
})
export class TypeImageViewInfermierComponent implements OnInit {
    ...
    constructor(private service: TypeImageInfermierService){
