...
@Component({
  selector: 'app-fiche-patient-view-infermier',
  templateUrl: './fiche-patient-view-infermier.component.html'
})
export class FichePatientViewInfermierComponent implements OnInit {
    ...
    constructor(private service: FichePatientInfermierService, private consultationService: ConsultationInfermierService, private antecedentService: AntecedentInfermierService){
