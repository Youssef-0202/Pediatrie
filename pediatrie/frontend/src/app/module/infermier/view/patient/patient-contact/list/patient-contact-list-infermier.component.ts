...
@Component({
  selector: 'app-patient-contact-list-infermier',
  templateUrl: './patient-contact-list-infermier.component.html'
})
export class PatientContactListInfermierComponent implements OnInit {
