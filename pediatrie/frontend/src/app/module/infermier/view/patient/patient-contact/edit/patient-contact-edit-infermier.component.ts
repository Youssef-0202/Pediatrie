...
@Component({
  selector: 'app-patient-contact-edit-infermier',
  templateUrl: './patient-contact-edit-infermier.component.html'
})
export class PatientContactEditInfermierComponent implements OnInit {
