...
@Component({
  selector: 'app-patient-contact-create-infermier',
  templateUrl: './patient-contact-create-infermier.component.html'
})
export class PatientContactCreateInfermierComponent  implements OnInit {
   ...
   private _validPatientContactEmail = true;
	...
	constructor(private service: PatientContactInfermierService , private relationService: RelationInfermierService, private patientService: PatientInfermierService, @Inject(PLATFORM_ID) private platformId? ) {
