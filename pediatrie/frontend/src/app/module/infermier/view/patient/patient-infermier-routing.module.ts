                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: PatientContactListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: RelationListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: PatientListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                },
                                {
                                    path: 'consultations',
...
export class PatientInfermierRoutingModule { }
