...
@Component({
  selector: 'app-patient-contact-view-infermier',
  templateUrl: './patient-contact-view-infermier.component.html'
})
export class PatientContactViewInfermierComponent implements OnInit {
    ...
    constructor(private service: PatientContactInfermierService, private relationService: RelationInfermierService, private patientService: PatientInfermierService){
