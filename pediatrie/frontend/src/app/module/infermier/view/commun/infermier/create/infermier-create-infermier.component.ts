...
@Component({
  selector: 'app-infermier-create-infermier',
  templateUrl: './infermier-create-infermier.component.html'
})
export class InfermierCreateInfermierComponent  implements OnInit {
