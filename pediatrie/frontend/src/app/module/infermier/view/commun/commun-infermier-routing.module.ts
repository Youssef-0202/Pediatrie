                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: SexeListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: InfermierListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: MedecinListInfermierComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class CommunInfermierRoutingModule { }
