...
@Component({
  selector: 'app-infermier-list-infermier',
  templateUrl: './infermier-list-infermier.component.html'
})
export class InfermierListInfermierComponent implements OnInit {
