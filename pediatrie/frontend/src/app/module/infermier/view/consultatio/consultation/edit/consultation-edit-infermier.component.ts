...
@Component({
  selector: 'app-consultation-edit-infermier',
  templateUrl: './consultation-edit-infermier.component.html'
})
export class ConsultationEditInfermierComponent implements OnInit {
