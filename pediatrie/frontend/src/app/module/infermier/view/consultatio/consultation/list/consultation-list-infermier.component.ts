...
@Component({
  selector: 'app-consultation-list-infermier',
  templateUrl: './consultation-list-infermier.component.html'
})
export class ConsultationListInfermierComponent implements OnInit {
