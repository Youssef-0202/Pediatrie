...
@Component({
    selector: 'app-register-infermier',
    templateUrl: './register-infermier.component.html',
    standalone: true,
    styleUrls: ['./register-infermier.component.css']
})
export class RegisterInfermierComponent implements OnInit {
