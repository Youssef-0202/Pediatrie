...
@Component({
  selector: 'app-certificat-view-admin',
  templateUrl: './certificat-view-admin.component.html'
})
export class CertificatViewAdminComponent implements OnInit {
    ...
    constructor(private service: CertificatAdminService, private consultationService: ConsultationAdminService){
