...
@Component({
  selector: 'app-analyse-medicale-create-admin',
  templateUrl: './analyse-medicale-create-admin.component.html'
})
export class AnalyseMedicaleCreateAdminComponent  implements OnInit {
