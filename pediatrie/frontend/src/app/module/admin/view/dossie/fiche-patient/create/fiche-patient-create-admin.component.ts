...
@Component({
  selector: 'app-fiche-patient-create-admin',
  templateUrl: './fiche-patient-create-admin.component.html'
})
export class FichePatientCreateAdminComponent  implements OnInit {
