...
@Component({
  selector: 'app-antecedent-view-admin',
  templateUrl: './antecedent-view-admin.component.html'
})
export class AntecedentViewAdminComponent implements OnInit {
    ...
    constructor(private service: AntecedentAdminService, private groupeSanguinService: GroupeSanguinAdminService){
