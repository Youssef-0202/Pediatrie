...
@Component({
  selector: 'app-analyse-medicale-view-admin',
  templateUrl: './analyse-medicale-view-admin.component.html'
})
export class AnalyseMedicaleViewAdminComponent implements OnInit {
    ...
    constructor(private service: AnalyseMedicaleAdminService, private consultationService: ConsultationAdminService, private epreuveService: EpreuveAdminService){
