...
@Component({
  selector: 'app-epreuve-view-admin',
  templateUrl: './epreuve-view-admin.component.html'
})
export class EpreuveViewAdminComponent implements OnInit {
    ...
    constructor(private service: EpreuveAdminService){
