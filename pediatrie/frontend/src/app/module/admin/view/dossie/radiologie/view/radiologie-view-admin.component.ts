...
@Component({
  selector: 'app-radiologie-view-admin',
  templateUrl: './radiologie-view-admin.component.html'
})
export class RadiologieViewAdminComponent implements OnInit {
    ...
    constructor(private service: RadiologieAdminService, private consultationService: ConsultationAdminService, private typeImageService: TypeImageAdminService){
