...
@Component({
  selector: 'app-analyse-medicale-edit-admin',
  templateUrl: './analyse-medicale-edit-admin.component.html'
})
export class AnalyseMedicaleEditAdminComponent implements OnInit {
