...
@Component({
  selector: 'app-synthese-medicale-create-admin',
  templateUrl: './synthese-medicale-create-admin.component.html'
})
export class SyntheseMedicaleCreateAdminComponent  implements OnInit {
