...
@Component({
  selector: 'app-synthese-medicale-edit-admin',
  templateUrl: './synthese-medicale-edit-admin.component.html'
})
export class SyntheseMedicaleEditAdminComponent implements OnInit {
