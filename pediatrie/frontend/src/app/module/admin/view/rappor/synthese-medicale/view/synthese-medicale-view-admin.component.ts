...
@Component({
  selector: 'app-synthese-medicale-view-admin',
  templateUrl: './synthese-medicale-view-admin.component.html'
})
export class SyntheseMedicaleViewAdminComponent implements OnInit {
    ...
    constructor(private service: SyntheseMedicaleAdminService, private consultationService: ConsultationAdminService){
