...
@Component({
  selector: 'app-infermier-list-admin',
  templateUrl: './infermier-list-admin.component.html'
})
export class InfermierListAdminComponent implements OnInit {
    ...
    constructor( private service: InfermierAdminService  , private sexeService: SexeAdminService, @Inject(PLATFORM_ID) private platformId?) {
