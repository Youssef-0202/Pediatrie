...
export class MedecinListAdminComponent implements OnInit {
    ...
    constructor( private http :HttpClient,private service: MedecinAdminService  , private sexeService: SexeAdminService, private sanitizer: DomSanitizer, @Inject(PLATFORM_ID) private platformId?) {
