...
export class MedecinCreateAdminComponent  implements OnInit {
   ...
   private _validMedecinEmail = true;
    ...
    typeConsultation: any[] | undefined=["1","2","3"];

	constructor(private infermierSer:InfermierAdminService  ,private authService: AuthService,private service: MedecinAdminService , private sexeService: SexeAdminService, @Inject(PLATFORM_ID) private platformId? ) {
    ...
    get infermiers() : Array<InfermierDto>{
        return this.infermierSer.items;
    }
