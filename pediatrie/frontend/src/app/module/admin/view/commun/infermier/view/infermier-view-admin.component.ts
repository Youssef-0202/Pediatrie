...
@Component({
  selector: 'app-infermier-view-admin',
  templateUrl: './infermier-view-admin.component.html'
})
export class InfermierViewAdminComponent implements OnInit {
    ...
    constructor(private service: InfermierAdminService, private sexeService: SexeAdminService){
