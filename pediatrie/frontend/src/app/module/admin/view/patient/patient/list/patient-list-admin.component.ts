...
export class PatientListAdminComponent implements OnInit {
    ...
    constructor( private service: PatientAdminService  , private patientContactService: PatientContactAdminService, private relationService: RelationAdminService, private sexeService: SexeAdminService, @Inject(PLATFORM_ID) private platformId?) {
