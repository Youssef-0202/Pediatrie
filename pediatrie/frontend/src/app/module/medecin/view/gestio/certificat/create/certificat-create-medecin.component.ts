...
@Component({
  selector: 'app-certificat-create-medecin',
  templateUrl: './certificat-create-medecin.component.html'
})
export class CertificatCreateMedecinComponent  implements OnInit {
