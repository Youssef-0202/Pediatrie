...
@Component({
  selector: 'app-ordonnance-create-medecin',
  templateUrl: './ordonnance-create-medecin.component.html'
})
export class OrdonnanceCreateMedecinComponent  implements OnInit {
