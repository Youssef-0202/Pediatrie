...
@Component({
  selector: 'app-medicament-create-medecin',
  templateUrl: './medicament-create-medecin.component.html'
})
export class MedicamentCreateMedecinComponent  implements OnInit {
