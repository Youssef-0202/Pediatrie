...
@Component({
  selector: 'app-medicament-view-medecin',
  templateUrl: './medicament-view-medecin.component.html'
})
export class MedicamentViewMedecinComponent implements OnInit {
    ...
    constructor(private service: MedicamentMedecinService, private traitementService: TraitementMedecinService){
