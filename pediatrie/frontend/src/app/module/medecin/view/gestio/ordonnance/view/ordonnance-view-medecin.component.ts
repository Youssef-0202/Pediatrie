...
@Component({
  selector: 'app-ordonnance-view-medecin',
  templateUrl: './ordonnance-view-medecin.component.html'
})
export class OrdonnanceViewMedecinComponent implements OnInit {
    ...
    constructor(private service: OrdonnanceMedecinService, private traitementService: TraitementMedecinService, private consultationService: ConsultationMedecinService){
