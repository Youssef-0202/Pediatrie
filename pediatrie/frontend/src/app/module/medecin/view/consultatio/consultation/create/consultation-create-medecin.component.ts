...
@Component({
  selector: 'app-consultation-create-medecin',
  templateUrl: './consultation-create-medecin.component.html'
})
export class ConsultationCreateMedecinComponent  implements OnInit {
   ...
   private _validConsultationRef = true;
    ...
    typeConsultation: any[] | undefined;
    ...
    ngOnInit(): void {
        ...
        this.typeConsultation=['Examens cliniques pédiatriques','Vaccination','Bilan de santénéonatale','Autre'];
    }


    public save(): void {
        console.log(this.item.medecin)
        this.submitted = true;
        this.validateForm();
    ...
    get heureFormat(){
        return environment.heureFormat;
    }
