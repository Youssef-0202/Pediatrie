...
@Component({
  selector: 'app-consultation-edit-medecin',
  templateUrl: './consultation-edit-medecin.component.html'
})
export class ConsultationEditMedecinComponent implements OnInit {
