...
@Component({
  selector: 'app-antecedent-create-medecin',
  templateUrl: './antecedent-create-medecin.component.html'
})
export class AntecedentCreateMedecinComponent  implements OnInit {
