...
@Component({
  selector: 'app-fiche-patient-view-medecin',
  templateUrl: './fiche-patient-view-medecin.component.html'
})
export class FichePatientViewMedecinComponent implements OnInit {
    ...
    constructor(private service: FichePatientMedecinService, private consultationService: ConsultationMedecinService, private antecedentService: AntecedentMedecinService){
