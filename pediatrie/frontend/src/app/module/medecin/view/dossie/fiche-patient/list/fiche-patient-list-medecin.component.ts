...
@Component({
  selector: 'app-fiche-patient-list-medecin',
  templateUrl: './fiche-patient-list-medecin.component.html'
})
export class FichePatientListMedecinComponent implements OnInit {
