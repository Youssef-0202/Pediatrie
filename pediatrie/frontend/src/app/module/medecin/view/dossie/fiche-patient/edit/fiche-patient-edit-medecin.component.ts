...
@Component({
  selector: 'app-fiche-patient-edit-medecin',
  templateUrl: './fiche-patient-edit-medecin.component.html'
})
export class FichePatientEditMedecinComponent implements OnInit {
