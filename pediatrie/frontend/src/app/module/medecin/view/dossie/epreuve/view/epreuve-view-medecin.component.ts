...
@Component({
  selector: 'app-epreuve-view-medecin',
  templateUrl: './epreuve-view-medecin.component.html'
})
export class EpreuveViewMedecinComponent implements OnInit {
    ...
    constructor(private service: EpreuveMedecinService){
