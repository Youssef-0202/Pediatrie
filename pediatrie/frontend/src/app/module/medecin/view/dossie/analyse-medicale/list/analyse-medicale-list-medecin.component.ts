...
@Component({
  selector: 'app-analyse-medicale-list-medecin',
  templateUrl: './analyse-medicale-list-medecin.component.html'
})
export class AnalyseMedicaleListMedecinComponent implements OnInit {
