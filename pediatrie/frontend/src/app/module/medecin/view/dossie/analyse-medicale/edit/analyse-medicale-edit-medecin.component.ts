...
@Component({
  selector: 'app-analyse-medicale-edit-medecin',
  templateUrl: './analyse-medicale-edit-medecin.component.html'
})
export class AnalyseMedicaleEditMedecinComponent implements OnInit {
