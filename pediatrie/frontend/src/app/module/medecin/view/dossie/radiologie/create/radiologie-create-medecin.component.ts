...
@Component({
  selector: 'app-radiologie-create-medecin',
  templateUrl: './radiologie-create-medecin.component.html'
})
export class RadiologieCreateMedecinComponent  implements OnInit {
