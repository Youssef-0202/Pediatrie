...
@Component({
  selector: 'app-analyse-medicale-view-medecin',
  templateUrl: './analyse-medicale-view-medecin.component.html'
})
export class AnalyseMedicaleViewMedecinComponent implements OnInit {
    ...
    constructor(private service: AnalyseMedicaleMedecinService, private consultationService: ConsultationMedecinService, private epreuveService: EpreuveMedecinService){
