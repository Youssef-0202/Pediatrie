...
@Component({
  selector: 'app-infermier-list-medecin',
  templateUrl: './infermier-list-medecin.component.html'
})
export class InfermierListMedecinComponent implements OnInit {

    protected fileName = 'Infermier';
    ...
    constructor( private service: InfermierMedecinService  , private sexeService: SexeMedecinService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<InfermierDto>();
    ...
    public async edit(dto: InfermierDto) {
    ...
    public async view(dto: InfermierDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: InfermierDto) {
    ...
    public async duplicate(dto: InfermierDto) {
    ...
    public exportPdf(dto: InfermierDto): void {
...
// add
	...
	public initDuplicate(res: InfermierDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<InfermierDto> {
        return this.service.selections;
    }

    set selections(value: Array<InfermierDto>) {
