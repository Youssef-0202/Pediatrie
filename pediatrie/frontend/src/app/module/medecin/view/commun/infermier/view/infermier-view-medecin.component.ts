...
@Component({
  selector: 'app-infermier-view-medecin',
  templateUrl: './infermier-view-medecin.component.html'
})
export class InfermierViewMedecinComponent implements OnInit {
    ...
    constructor(private service: InfermierMedecinService, private sexeService: SexeMedecinService){
