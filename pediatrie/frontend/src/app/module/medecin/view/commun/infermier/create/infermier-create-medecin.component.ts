...
@Component({
  selector: 'app-infermier-create-medecin',
  templateUrl: './infermier-create-medecin.component.html'
})
export class InfermierCreateMedecinComponent  implements OnInit {
