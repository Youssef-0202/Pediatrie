...
export class PatientListMedecinComponent implements OnInit {
    ...
    constructor( private service: PatientMedecinService  , private patientContactService: PatientContactMedecinService, private relationService: RelationMedecinService, private sexeService: SexeMedecinService, @Inject(PLATFORM_ID) private platformId?) {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'numDossier', header: 'Num dossier'},
	...
	public initDuplicate(res: PatientDto) {
        if (res.patientContact != null) {
             res.patientContact.forEach(d => { d.patient = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            'Num dossier': this.criteria.numDossier ? this.criteria.numDossier : environment.emptyForExport ,
