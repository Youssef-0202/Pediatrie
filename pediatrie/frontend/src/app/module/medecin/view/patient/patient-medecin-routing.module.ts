                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: PatientContactListMedecinComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: RelationListMedecinComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: PatientListMedecinComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class PatientMedecinRoutingModule { }
