...
@Component({
  selector: 'app-synthese-medicale-create-medecin',
  templateUrl: './synthese-medicale-create-medecin.component.html'
})
export class SyntheseMedicaleCreateMedecinComponent  implements OnInit {
