...
@Component({
  selector: 'app-synthese-medicale-view-medecin',
  templateUrl: './synthese-medicale-view-medecin.component.html'
})
export class SyntheseMedicaleViewMedecinComponent implements OnInit {
    ...
    constructor(private service: SyntheseMedicaleMedecinService, private consultationService: ConsultationMedecinService){
