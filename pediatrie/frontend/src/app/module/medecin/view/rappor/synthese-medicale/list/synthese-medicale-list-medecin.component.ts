...
@Component({
  selector: 'app-synthese-medicale-list-medecin',
  templateUrl: './synthese-medicale-list-medecin.component.html'
})
export class SyntheseMedicaleListMedecinComponent implements OnInit {
