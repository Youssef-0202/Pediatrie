...
export class InfermierAdminService {
    protected _API = '';
    ...
    public save(infermier:InfermierDto): Observable<InfermierDto> {
        return this.http.post<any>('http://localhost:8036/api/admin/infermier/', infermier);
    }
    ...
    get         API() {
        return environment.apiUrlPediatrieservice + 'admin/infermier/';
    }
