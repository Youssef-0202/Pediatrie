...
export class AnalyseMedicaleMedecinService {
    protected _API = '';
    ...
    findByConsultationRef(ref: string) {
        return this.http.get<Array<AnalyseMedicaleDto>>('http://localhost:8036/api/medecin/analyseMedicale/consultation/num/'+ref)
    }
    ...
    get API() {
        return environment.apiUrlPediatrieservice + 'medecin/analyseMedicale/';
    }
